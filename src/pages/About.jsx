      ...
      <section className='about py-16'>
        <div className='container'>
          <div className='heading text-center py-12'>
            <h1 className='text-3xl font-semibold text-black'>Buddy, no need to worry coz you got <b className='text-teal-500'> EDUBUDDY! </b></h1>
            <span className='text-sm mt-2 block'> Where Learning Meets Innovation, and Every Step Leads to Greatness! </span>
          </div>
        ...
        <div className='left w-1/3 md:w-full mr-8 md:mr-0 relative'>
          ...
          <div className='img-group ml-24 mt-3'>
            ...
            <span className='text-[14px]'>
              Join over <label className='text-black text-sm'>6300</label> students
            </span>
          </div>
        </div>
        <div className='right w-2/3 md:w-full md:mt-16'>
          <div className='heading w-4/5 md:w-full'>
            <h1 className='text-2xl font-semibold text-black'>Achieve Your Goals With EDUBUDDY</h1>
            <span className='text-sm mt-2 block leading-6'> At EDUBUDDY, we empower organizations to thrive by providing access to over 350 online courses designed to upskill your team. Our platform features the latest skills and industry trends, ensuring your workforce stays competitive and innovative. Whether you're looking to enhance technical abilities, improve soft skills, or foster leadership development, EDUBUDDY is your partner in continuous learning and professional growth. Join us in transforming the learning experience and unlocking your team's full potential!</span>
            <ul className='my-5'>
              ...
              <li className='text-sm flex items-center gap-5 my-2'>
                ...
                Access more than 350 online courses
              </li>
              <li className='text-sm flex items-center gap-5'>
                <AiOutlineCheck className='text-green-500' />
