...
import devaformal from "../components/assets/images/devaformal.jpg"
      ...
      <section className='courses bg-[#F3F4F8] py-16 '>
        <div className='w-4/5 m-auto'>
          <div className='heading mb-16'>
            ...
            <span className='text-sm mt-2 block'>Personalized Learning Paths to Fuel Your Ambitions!</span>
          </div>
                ...
                <div className='text p-3'>
                  <div className='flex justify-between items-center'>
                    ...
                    <div className='flex items-center'>
                      ...
                      <span className='text-[14px] ml-2'> 4.5(21)</span>
                    </div>
                  </div>
                  <h3 className='text-black my-4 font-medium h-10'>{item.title}</h3>
                  <div className='user flex items-center'>
                    <img className='rounded-full w-8 h-10' src= { devaformal } alt='' />
                    <span className='text-[14px] ml-2'> Devanshu </span>
                  </div>
                </div>
