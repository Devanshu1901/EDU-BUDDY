      ...
      <section className='instructor mb-16'>
        <div className='container'>
          <div className='heading py-12 text-center w-2/3 m-auto md:w-full'>
            <h1 className='text-3xl font-semibold text-black'>What Is EDUBUDDY?</h1>
            <span className='text-[14px] mt-2 block'>It’s your all-in-one learning partner, designed to guide you in mastering new skills, unlocking your potential, and excelling in your educational journey. With EDUBUDDY, learning is personalized, efficient, and fun—bringing the best resources right to your fingertips!</span>
          </div>
          ...
          <div className='content'>
            ...
            <div className='content grid grid-cols-4 gap-5 md:grid-cols-2'>
              <InstructorCard color='text-red-500' icon={<FaUsers size={40} />} title='6300+' desc='Students Enrolled' />
              <InstructorCard color='text-orange-500' icon={<GiEvilBook size={40} />} title='350+' desc='Total Courses' />
              <InstructorCard color='text-purple-500' icon={<FaGraduationCap size={40} />} title='4500+' desc='Online Learners' />
              <InstructorCard color='text-indigo-500' icon={<GiWorld size={40} />} title='100+' desc='Online Educators' />
            </div>
          </div>
        </div>
      </section>
