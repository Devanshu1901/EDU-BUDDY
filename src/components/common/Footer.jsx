    ...
    <>
      <section className='app w-4/5 m-auto rounded-lg shadow-shadow2 text-white flex md:flex-col bg-primary mt-16 relative z-10'>
        <div className='left w-[60%] md:w-full p-10'>
          <h1 className='text-4xl font-semibold leading-tight'>
            Start learning by <br /> Downloading App.
          </h1>
        </div>
      ...
      <footer className='bg-[#F3F4F8] py-10 pt-32 -mt-24'>
        <div className='container grid grid-cols-4 gap-5 md:grid-cols-2'>
          <div className='logo'>
            <img src={EDUBUDDY} alt='EDUBUDDY' className='h-5' />
            <span className='text-[14px]'>Inspiring lesson ideas and resources for teachers! Empower educators to craft personalized lesson plans that fit their unique classroom needs.</span>
          </div>
